...
1. Gilfoyle writes authentication module
2. Bighead (Tester) reviews → rejects: "Error handling is missing. Russ Hannerman should fix this."
3. Coordinator: Gilfoyle is now locked out of this artifact
4. Coordinator spawns Russ Hannerman to revise the authentication module
5. Russ Hannerman produces v2
6. Bighead reviews v2 → approves
7. Lockout clears for next artifact

**Example 2: Escalate for expertise**
1. Peter Gregory writes TypeScript config
2. Laurie Bream (Lead) reviews → rejects: "Need someone with deeper TS knowledge. Escalate."
3. Coordinator: Peter Gregory is now locked out
4. Coordinator spawns new agent (or existing TS expert) to revise
5. New agent produces v2
6. Laurie Bream reviews v2

**Example 3: Deadlock handling**
1. Gilfoyle writes module → rejected
2. Russ Hannerman revises → rejected
3. Bighead revises → rejected
...
1. Gilfoyle writes module → rejected
2. Bighead says: "Gilfoyle should fix the error handling"
3. Coordinator: "Gilfoyle is locked out as the original author. Please name a different agent."
4. Bighead: "Russ Hannerman, then"
5. Coordinator spawns Russ Hannerman
